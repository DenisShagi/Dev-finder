...
const IconCompany = (props: React.SVGProps<SVGSVGElement>) => (
...
const IconTwitter = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="18px" {...props}>
    <path
...
const IconLocation = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="14px" height="20px" {...props}>
    <path
